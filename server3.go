...
func HandleServerDNSConnection() {
	tcpAddr, _ := net.ResolveTCPAddr("tcp", "192.168.0.112:1111")
	listener, _ := net.ListenTCP("tcp", tcpAddr)

	for {
		fmt.Println("Server 3 listening dns on port 1111...")
		listener.AcceptTCP()
		fmt.Println()
	}
}
...
func ServerHello() {
	...
	tcpAddr, _ := net.ResolveTCPAddr("tcp", "192.168.0.112:2424")
	...
	msg := &messageFormat.MessageFormat{
		Origin:  "Server",
		ReqType: "Hello",
		Payload: []string{"Server2", "192.168.0.112:2121", "192.168.0.112:1111"},
	}
